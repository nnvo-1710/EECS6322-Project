    ...
    def forward(self, input_seq, seq_lengths, supports):
        ...
        for i in range(self.num_layers):
            ...
            for t in range(seq_len):
                input_t = current_inputs[t]  # shape: (batch_size, num_nodes, input_dim)


                input_t = input_t.view(input_t.shape[0], input_t.shape[1] * input_t.shape[2])  # (B, num_nodes * input_dim)
