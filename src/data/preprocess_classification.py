...
FILE_MARKER_DIR = '/local/home/nnvo/EECS 6322 - Project/DataExtract/Filemarkers_classification'
...
def main(
    ...
    all_tuples = test_tuples #+ dev_tuples + test_tuples
    ...
    for idx in tqdm(range(len(all_tuples))):
        edf_fn, label, seizure_idx,start,end = all_tuples[idx]
