...
FILEMARKER_DIR = '/local/home/nnvo/EECS 6322 - Project/DataExtract/Filemarkers_classification'
...
def computeSliceMatrix(
    ...
    # get seizure times
    seizure_times = getSeizureTimes(edf_fn.split('.edf')[0], group)
    start_time = float(start_time)
    end_time = float(end_time)
    curr_seizure_time = [start_time, end_time]

    if seizure_idx - 1 > len(seizure_times) - 1:
