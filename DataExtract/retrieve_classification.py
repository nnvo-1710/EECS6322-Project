...
directory = "./classification_pre/train/clipLen12_timeStepSize1"
batch_size = 100
normalization_method = "global"  # Choose your normalization method: "global", "per_clip_channel", etc.
filter_type = "laplacian"  # Specify the filter type: "laplacian", "random_walk", etc.
use_combined_graph = False  # Set this to False if you want to use individual adjacency matrices
